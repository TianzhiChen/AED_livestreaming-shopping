...
public class ScheduleJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        liveScheTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Double.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class
            };
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 100, 380, 310));
...
//        }
    ...
    private void assignBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignBtnActionPerformed
        ...
        populateLiveSche(product.getProductName(), product.getProductPrice(), schedule.getDate(), schedule.getName(), stock);
    ...
    private void updateProOfferBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateProOfferBtnActionPerformed
        ...
        populateLiveSche(product.getProductName(), product.getProductPrice(), date, schedule.getName(), stock);
    ...
    public void populateLiveSche(String productName, double price, Date date, String scheduleName, int stock) {
        liveScheTableModel.setRowCount(0);
        Merchant m = this.business.getMerchantDirectory().findMerchantByName(this.userAccount.getUsername());
        Schedule s = m.getScheduleDirectory().findScheduleByName(scheduleName);
