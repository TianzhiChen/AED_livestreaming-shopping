            ...
            if (this.business.getMerchantDirectory().findMerchantByName(this.userAccount.getUsername()) != null) {
                ...
                if (m.getProductCatalog().productExists(productName)) {
                    ...
                    if (createdProduct != null) {
                        Date date = new Date();
                          ScheduleDirectory sss =m.getScheduleDirectory();
                            
                         Schedule schedule = sss.createSchedule(UUID.randomUUID().toString(), date);
                            Map<String, ProductOffer> productMap = schedule.getProductMap();
                            ProductOffer a1= new ProductOffer(createdProduct,10);
                            productMap.put(createdProduct.getProductName(),a1 );
