...
public class DashboardJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(panelPieChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 50, 310, 300));

        panelLineChart.setLayout(new java.awt.BorderLayout());
        add(panelLineChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 50, 350, 300));

        panelBarChart.setLayout(new java.awt.BorderLayout());
        add(panelBarChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 430, 300));
